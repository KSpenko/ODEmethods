...
plt.plot(sc3[0], sc3[1], label='scipy.RK45', color='gold')
plt.plot(sc4[0], sc4[1], label='scipy.DOP853', color='cyan')
...
plt.semilogy(sc3[0], np.absolute(sc3[0]-analytical_heat(sc3[0], 21, par)), label='scipy.RK45', color='gold')
plt.semilogy(sc4[0], np.absolute(sc4[0]-analytical_heat(sc4[0], 21, par)), label='scipy.DOP853', color='cyan')
plt.xlabel(r'$t$')
...
plt.loglog(sc3[0], np.absolute(sc3[0]-analytical_heat(sc3[0], 21, par)), label='scipy.RK45', color='gold')
plt.loglog(sc4[0], np.absolute(sc4[0]-analytical_heat(sc4[0], 21, par)), label='scipy.DOP853', color='cyan')
plt.xlabel(r'$t$')
plt.ylabel(r'$\Delta T(t)$')
plt.legend(fontsize="x-small")
