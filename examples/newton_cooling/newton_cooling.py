...
rk1 = problem_rk.run(x0=0, y0=21, init_step=1.)

problem_rk.method = rk_methods["cash_karp"]
rk2 = problem_rk.run(x0=0, y0=21, init_step=1., adaptive=True, tolerance=10e-9)

problem_rk.method = rk_methods["dormand_prince"]
rk3 = problem_rk.run(x0=0, y0=21, init_step=1., adaptive=True, tolerance=10e-9)
